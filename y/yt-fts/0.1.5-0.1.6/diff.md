# Comparing `tmp/yt-fts-0.1.5.tar.gz` & `tmp/yt-fts-0.1.6.tar.gz`
...
## Comparing `yt-fts-0.1.5.tar` & `yt-fts-0.1.6.tar`
...
### Comparing `yt-fts-0.1.5/LICENSE` & `yt-fts-0.1.6/LICENSE`

 * *Files identical despite different names*

### Comparing `yt-fts-0.1.5/PKG-INFO` & `yt-fts-0.1.6/PKG-INFO`
...
### Comparing `yt-fts-0.1.5/README.md` & `yt-fts-0.1.6/README.md`

 * *Files identical despite different names*

### Comparing `yt-fts-0.1.5/setup.py` & `yt-fts-0.1.6/setup.py`
...
### Comparing `yt-fts-0.1.5/yt_fts/db_scripts.py` & `yt-fts-0.1.6/yt_fts/db_scripts.py`

 * *Files identical despite different names*

### Comparing `yt-fts-0.1.5/yt_fts/yt_fts.py` & `yt-fts-0.1.6/yt_fts/yt_fts.py`

 * *Files identical despite different names*

### Comparing `yt-fts-0.1.5/yt_fts.egg-info/PKG-INFO` & `yt-fts-0.1.6/yt_fts.egg-info/PKG-INFO`
