# Comparing `tmp/stigg_api_client-0.445.2.tar.gz` & `tmp/stigg_api_client-0.5.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "stigg_api_client-0.445.2.tar", max compression
+gzip compressed data, was "stigg_api_client-0.5.0.tar", max compression
```

## Comparing `stigg_api_client-0.445.2.tar` & `stigg_api_client-0.5.0.tar`

### file list

```diff
@@ -1,8 +1,8 @@
--rw-r--r--   0        0        0     2479 2023-05-29 07:02:02.740370 stigg_api_client-0.445.2/README.md
--rw-r--r--   0        0        0      460 2023-05-29 07:02:40.858360 stigg_api_client-0.445.2/pyproject.toml
--rw-r--r--   0        0        0       44 2023-05-29 07:02:02.740370 stigg_api_client-0.445.2/stigg/__init__.py
--rw-r--r--   0        0        0     1141 2023-05-29 07:02:02.740370 stigg_api_client-0.445.2/stigg/client.py
--rw-r--r--   0        0        0        0 2023-05-29 07:02:38.642246 stigg_api_client-0.445.2/stigg/generated/__init__.py
--rw-r--r--   0        0        0    46357 2023-05-29 07:02:39.142271 stigg_api_client-0.445.2/stigg/generated/operations.py
--rw-r--r--   0        0        0   458053 2023-05-29 07:02:38.966262 stigg_api_client-0.445.2/stigg/generated/schema.py
--rw-r--r--   0        0        0     3117 1970-01-01 00:00:00.000000 stigg_api_client-0.445.2/PKG-INFO
...
### Comparing `stigg_api_client-0.445.2/README.md` & `stigg_api_client-0.5.0/README.md`

 * *Files identical despite different names*

### Comparing `stigg_api_client-0.445.2/stigg/client.py` & `stigg_api_client-0.5.0/stigg/client.py`

 * *Files identical despite different names*

### Comparing `stigg_api_client-0.445.2/stigg/generated/operations.py` & `stigg_api_client-0.5.0/stigg/generated/operations.py`
...
### Comparing `stigg_api_client-0.445.2/stigg/generated/schema.py` & `stigg_api_client-0.5.0/stigg/generated/schema.py`
...
### Comparing `stigg_api_client-0.445.2/PKG-INFO` & `stigg_api_client-0.5.0/PKG-INFO`
