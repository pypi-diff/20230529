# Comparing `tmp/thsquant-0.1.6.tar.gz` & `tmp/thsquant-0.1.7.tar.gz`
...
## Comparing `thsquant-0.1.6.tar` & `thsquant-0.1.7.tar`
...
### Comparing `thsquant-0.1.6/LICENSE.txt` & `thsquant-0.1.7/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `thsquant-0.1.6/PKG-INFO` & `thsquant-0.1.7/PKG-INFO`
...
### Comparing `thsquant-0.1.6/setup.py` & `thsquant-0.1.7/setup.py`
...
### Comparing `thsquant-0.1.6/thsquant.egg-info/PKG-INFO` & `thsquant-0.1.7/thsquant.egg-info/PKG-INFO`
