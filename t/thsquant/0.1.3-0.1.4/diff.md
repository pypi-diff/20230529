# Comparing `tmp/thsquant-0.1.3.tar.gz` & `tmp/thsquant-0.1.4.tar.gz`
...
## Comparing `thsquant-0.1.3.tar` & `thsquant-0.1.4.tar`
...
### Comparing `thsquant-0.1.3/LICENSE.txt` & `thsquant-0.1.4/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `thsquant-0.1.3/PKG-INFO` & `thsquant-0.1.4/PKG-INFO`
...
### Comparing `thsquant-0.1.3/setup.py` & `thsquant-0.1.4/setup.py`
...
### Comparing `thsquant-0.1.3/thsquant.egg-info/PKG-INFO` & `thsquant-0.1.4/thsquant.egg-info/PKG-INFO`
